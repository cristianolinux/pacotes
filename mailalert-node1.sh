...
# Executar script no node1 - Servidor Master
...
echo "
echo 'O Node2 está Parado, Favor Verificar!' | mail -s 'VocallCenter Node2 - ${emp}' cristiano.h@eox.com.br cristianolinux@gmail.com
